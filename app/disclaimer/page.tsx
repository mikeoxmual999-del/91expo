...
export default function DisclaimerPage() {
  const sections = [
    ...
    {
      title: "3. 非法律意见", titleEn: "Not Legal Advice",
    ...
    {
      title: "4. 责任限制", titleEn: "Limitation of Liability",
    ...
    {
      title: "5. 第三方链接", titleEn: "Third-Party Links",
    ...
    {
      title: "6. 内容删除", titleEn: "Content Removal",
    ...
    {
      title: "7. 修改权利", titleEn: "Right to Modify",
