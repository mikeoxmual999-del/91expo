...
export default function DisclaimerPage() {
  const sections = [
    {
      title: "1. 平台性质", titleEn: "1. Platform Nature",
    ...
    {
      title: "2. 内容真实性", titleEn: "2. Content Accuracy",
    ...
    {
      title: "3. 非法律意见", titleEn: "3. Not Legal Advice",
    ...
    {
      title: "4. 责任限制", titleEn: "4. Limitation of Liability",
    ...
    {
      title: "5. 第三方链接", titleEn: "5. Third-Party Links",
    ...
    {
      title: "6. 内容删除", titleEn: "6. Content Removal",
    ...
    {
      title: "7. 修改权利", titleEn: "7. Right to Modify",
  ...
  return (
    <main className="min-h-screen bg-[#F5F7FA] text-[#1F2937]">
      <div className="max-w-[900px] mx-auto px-4 md:px-8 py-10 md:py-20">
        ...
        <div className="mb-12">
          <div className="text-[#2B6CB0] text-sm font-medium uppercase tracking-widest mb-2">法律声明 / Legal Notice</div>
          <h1 className="text-3xl md:text-4xl font-bold text-[#0F2A44] mb-1 leading-tight">免责声明</h1>
          <h2 className="text-xl font-semibold text-[#0F2A44]/40 mb-4">Disclaimer</h2>
