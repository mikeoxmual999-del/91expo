...
export default function TermsPage() {
  const sections = [
    {
      title: "1. 服务说明", titleEn: "1. Service Description",
    ...
    {
      title: "2. 用户注册", titleEn: "2. User Registration",
      content: "用户须使用真实有效的手机号码或邮箱进行注册。每个账号仅可注册一个账户。您有责任妥善保管账户信息，因账户被盗用或泄露所造成的损失由用户自行承担。",
      contentEn: "Users must register with a valid phone number or email address. Each contact may only be associated with one account. You are responsible for keeping your account information secure. Losses resulting from unauthorized access are borne by the user.",
    },
    {
      title: "3. 用户行为规范", titleEn: "3. User Conduct",
    ...
    {
      title: "4. 内容所有权", titleEn: "4. Content Ownership",
    ...
    {
      title: "5. 平台权利", titleEn: "5. Platform Rights",
    ...
    {
      title: "6. 私信功能", titleEn: "6. Messaging Feature",
    ...
    {
      title: "7. 服务变更", titleEn: "7. Service Changes",
    ...
    {
      title: "8. 争议解决", titleEn: "8. Dispute Resolution",
    ...
    <main className="min-h-screen bg-[#F5F7FA] text-[#1F2937]">
      <div className="max-w-[900px] mx-auto px-4 md:px-8 py-10 md:py-20">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-2xl px-6 md:px-8 py-6 mb-6">
          ...
          <p className="text-[#2B6CB0]/60 text-sm leading-relaxed italic">Please read the following agreement carefully before using this platform. By registering or using our services, you confirm that you have read, understood, and agreed to all terms.</p>
        </div>
