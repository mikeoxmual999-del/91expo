      ...
      <div className="max-w-[1000px] mx-auto px-8 py-16">
        ...
        <div className="relative mb-10">
          <input
            ...
            className="w-full bg-[#111827] border border-white/10 px-5 py-4 rounded-xl text-white placeholder:text-white/30 focus:outline-none focus:border-blue-500 transition text-sm pr-12"
          />
          {query && (
            <button
              onClick={() => setQuery("")}
        ...
        {query.trim() && filtered.length === 0 && (
          <div className="text-center py-24">
            <div className="text-5xl mb-4">🔍</div>
            <div className="text-white/40 text-sm mb-2">未找到相关记录</div>
