  ...
  const sections = [
    {
      ...
      content: "我们收集您在注册和使用平台过程中主动提供的信息，包括手机号码、发布的争议内容、私信内容及协调请求信息。我们也会自动收集设备信息和访问日志，用于平台安全和性能优化。",
      contentEn: "We collect information you actively provide during registration and use, including your phone number, submitted dispute content, messages, and coordination requests. We also automatically collect device information and access logs for platform security and performance.",
    },
    {
      title: "2. 信息使用方式",
    ...
    },
    {
      ...
      content: "目前平台使用浏览器本地存储（localStorage）保存用户数据。数据存储在您的本地设备上。我们建议您不要在公共设备上使用本平台账户，以保护您的个人信息安全。",
      contentEn: "The platform currently uses browser local storage (localStorage) to save user data on your local device. We recommend that you avoid using your account on public devices to protect your personal information.",
    },
    {
      title: "4. 信息共享",
    ...
    {
      title: "7. 未成年人保护",
      titleEn: "7. Protection of Minors",
    ...
    <main className="min-h-screen bg-[#F5F7FA] text-[#1F2937]">
      <div className="max-w-[900px] mx-auto px-8 py-20">
        ...
        <div className="mb-14">
          ...
          <h1 className="text-4xl font-bold text-[#0F2A44] mb-1 leading-tight">隐私政策</h1>
          <h2 className="text-xl font-semibold text-[#0F2A44]/60 mb-4">Privacy Policy</h2>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-2xl px-8 py-6 mb-8">
          <p className="text-[#2B6CB0] text-sm leading-relaxed mb-2">我们重视您的隐私。本政策说明我们如何收集、使用和保护您在使用 91记录 平台时提供的个人信息。</p>
          <p className="text-[#2B6CB0]/70 text-sm leading-relaxed italic">We value your privacy. This policy explains how we collect, use, and protect the personal information you provide when using the 91Records platform.</p>
        </div>
