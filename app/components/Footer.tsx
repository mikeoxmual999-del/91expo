...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#0B0F14] mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link href="/feed" className="text-white/60 hover:text-white text-sm transition">
                争议记录
              </Link>
              <Link href="/create" className="text-white/60 hover:text-white text-sm transition">
                发布纠纷
              </Link>
              <Link href="/search" className="text-white/60 hover:text-white text-sm transition">
                搜索企业
              </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link href="/admin" className="text-white/20 hover:text-white/40 text-xs transition mt-2">
                管理员入口
              </Link>
            </div>
          </div>
